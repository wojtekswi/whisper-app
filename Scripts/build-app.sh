...
cp "$root/LICENSE" "$app/Contents/Resources/Licenses/WhisperTranscriber-MIT.txt"
cp "$root/THIRD_PARTY_NOTICES.md" "$app/Contents/Resources/"
cp "$root/Vendor/whisper.cpp/LICENSE" "$app/Contents/Resources/Licenses/whisper.cpp-MIT.txt"
cp "$root/Vendor/ffmpeg/COPYING.LGPLv2.1" "$app/Contents/Resources/Licenses/FFmpeg-LGPL-2.1.txt"
